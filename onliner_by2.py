...
def get_date():
    ...
    url = f"https://www.onliner.by/sdapi/catalog.api/search/mobile?order=date:desc&page=1"
        ...
        for item in range(items_count):
            ...
            if second > 0:
                ...
                for a in range(second):
                    ...
                    date_created1 = date["offers"][a]["created_at"]
                    # date_created = datetime.strptime(date_created1[:-6], "%Y-%m-%dT%H:%M:%S")
